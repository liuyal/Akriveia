...
\newglossaryentry{Hostapd}{name=Hostapd, description={Host access point daemon}}
...
\newglossaryentry{OSI}{name=OSI Model, description={Open Systems Interconnection model}}
...
\newglossaryentry{Rolling Releases}{name=Rolling Release, description={Frequent updates of software, without versions}}
