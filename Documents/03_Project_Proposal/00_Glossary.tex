...
\newglossaryentry{ESSS}{name=ESSS, description={SFU Engineering Science Student Society}}
...
\newglossaryentry{GIL}{name=GIL, description={Global Indoor Location }}
\newglossaryentry{GPS}{name=GPS, description={Global Position Systems }}
...
\newglossaryentry{SAR}{name=SAR, description={Search and Rescue}}
